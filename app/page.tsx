    ...
    <main className={styles.page}>
      ...
      <div className={styles.manifesto}>
        <Text>
          ...
          not locked behind proprietary walls, not concentrated in the hands of a few, but shared
          freely as a common inheritance of our species. Atelier Rhizome exists to make that belief
          real.
        </Text>
        ...
        <Text>
          ...
          trust. We develop local models that run on the hardware people already own, free from the
          tether of distant servers. And we relentlessly optimize for efficiency, because a model
          that demands a datacenter to run is a model that excludes most of the world.
        </Text>

        <Text>
          This is not work that any one person or institution can do alone. Like the rhizome — that
          tangle of roots with no center and no hierarchy — we grow by connecting. Every
